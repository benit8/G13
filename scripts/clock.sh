...
do
	...
	postparams="-pointsize 14 -fill black -font FreeMono -draw \"text 60,15 '$Date'\" -draw \"text 68,30 '$Time'\" pbm:- "
	cmd="convert $preparams $ticks $postparams"

	eval $cmd | ./pbm2lpbm > /tmp/g13-0
	sleep 0.33
done