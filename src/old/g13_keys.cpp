...
void G13::Profile::_init_keys()
{
	int key_index = 0;

	// create a G13_Key entry for every key in G13_KEY_SEQ
#define INIT_KEY(r, data, elem) { \
	G13::Key key(*this, BOOST_PP_STRINGIZE(elem), key_index++); \
	_keys.push_back(key); \
} \

	BOOST_PP_SEQ_FOR_EACH(INIT_KEY, _, KEY_SEQ)
...
#define MARK_NON_PARSED_KEY(r, data, elem) { \
	...
	BOOST_PP_SEQ_FOR_EACH(MARK_NON_PARSED_KEY, _, NONPARSED_KEY_SEQ)
}

////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////

void G13::Key::dump(std::ostream &o) const
{
...
void G13::Profile::dump(std::ostream &o) const
{
...
void G13::Profile::parse_keys(unsigned char *buf)
{
	buf += 3;
...
G13_Key *G13::Profile::find_key(const std::string &keyname)
{
...
void G13::Key::parse_key(unsigned char *byte, G13::Device *g13)
{
...
void G13::Manager::init_keynames()
{
	int key_index = 0;
	...
	BOOST_PP_SEQ_FOR_EACH(ADD_G13_KEY_MAPPING, _, G13::KEY_SEQ)
...
LINUX_KEY_VALUE G13::Manager::find_g13_key_value(const std::string &keyname) const
{
...
LINUX_KEY_VALUE G13::Manager::find_input_key_value(const std::string &keyname) const
{

	// if there is a KEY_ prefix, strip it off
	if (strncmp(keyname.c_str(), "KEY_", 4) == 0) {
...
std::string G13::Manager::find_input_key_name(LINUX_KEY_VALUE v) const
{
	try {
...
std::string G13::Manager::find_g13_key_name(G13_KEY_INDEX v) const
{
	try {
